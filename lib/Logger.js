...
const homeyLog = typeof Homey.env.HOMEY_LOG_URL === 'string' ? require('homey-log').Log : null; // eslint-disable-line
const setTags = homeyLog ? homeyLog.setTags.bind(homeyLog) : () => null;
const setUser = homeyLog ? homeyLog.setUser.bind(homeyLog) : () => null;
const setExtra = homeyLog ? homeyLog.setExtra.bind(homeyLog) : () => null;
const captureMessage = homeyLog ? homeyLog.captureMessage.bind(homeyLog) : () => null;
const captureException = homeyLog ? homeyLog.captureException.bind(homeyLog) : () => null;
 ...
 */
class Logger {
	constructor({ logLevel = 4, captureLevel = 5, prefix, logFunc = console.log, errorFunc = console.error}) {
